...
const ProductDetails = ({ params }) => {
  ...
  return (
    <div className=" flex flex-col justify-center items-center py-12 md:py-20 px-4 md:px-20 max-w-[1600px] min-h-screen">
      <div className="flex flex-col lg:flex-row gap-[120px] p-10 lg:max-h-[800px] justify-between h-auto">
        <div className="w-full lg:w-[50%] bg-[#f5f5f5] h-auto p-16">
          <img
            src={product?.img}
        ...
        <div className="flex flex-col gap-8 w-full lg:w-[50%] h-auto">
          <div className="flex flex-col gap-4">
            ...
            <p className="text-[14px] max-w-[357px]">
          ...
          <div className="flex gap-5 items-center">
                <h1 className="text-[20px] font-medium">Sizes:</h1>
                <div className="flex gap-3 items-center">
                    {sizes.map((size) => (
                        <div 
                        key={size.id}
                        onClick={() => handleChangeSize(size.size)} 
                        className={`w-[35px] p-2 h-[35px] cursor-pointer ${activeSize===size.size?"bg-[#db4444] text-white":"text-black"} text-[14px] font-medium flex justify-center items-center border border-black rounded-[5px]`}
                        >
                            {size.size}
                        </div>
                    ))}
          ...
          <div className="flex gap-5 items-center h-auto">
            <div className="flex max-w-[160px] h-[50px] border border-black items-center rounded-md">
          ...
          <div className="flex flex-col h-auto">
            ...
            <div className="w-full border-2 border-black border-t-0 p-4 flex gap-5 items-center rounded-b-md">
                ...
                <div className="flex flex-col gap-2">
                    ...
                    <p className="text-[0.75rem] font-medium">Free 30 Days Delivery Returns. Details</p>
                </div>
            </div>
          </div>
        </div>
