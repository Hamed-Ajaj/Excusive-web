...
const ProductCard = () => {
  return (
    <div className='flex flex-col gap-4 w-[270px] h-auto md:h-[250px] relative '>
      <div className='bg-[#F5F5F5] px-6 py-16 w-full flex justify-center items-center'>
        <img src="/products/product1.svg" alt="jacket" />
      </div>
      <div className='w-full space-y-3'>
        <h4 className='font-medium'>The north coat</h4>
        <div className='flex flex-col gap-3'>
          <p className='space-x-4'><span className='font-medium text-[#DB4444]'>260$</span><span className='font-medium text-[#7D8184] line-through'>300$</span>
          </p>
