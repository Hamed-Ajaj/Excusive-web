    ...
    <div  className="py-10 my-10">
      ...
      <Suspense fallback={<p>Loading...</p>}>
          {statistics.map((statistic) => (
            <div key={statistic.id} className="flex flex-col border rounded-md max-h-[250px] w-[300px] p-10 gap-8 justify-center items-center group hover:bg-[#db4444] hover:text-white">
              <div>
                <div>
